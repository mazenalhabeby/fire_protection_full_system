...
// Status display configuration - labels will be translated in component
const getStatusConfig = (t: (key: string) => string): Record<string, { color: string; icon: React.ReactNode; label: string }> => ({
  ACTIVE: { color: "primary", icon: <UserCheck className="h-3 w-3" />, label: t("referrals.status.active") },
  CONVERTED: { color: "success", icon: <CheckCircle className="h-3 w-3" />, label: t("referrals.status.converted") },
  INACTIVE: { color: "secondary", icon: <XCircle className="h-3 w-3" />, label: t("referrals.status.inactive") },
});
...
export default function AffiliatesPage() {
  ...
  const _handleClaim = async () => {
    try {
      ...
      toast.success(t("toast.claimSuccess", { amount: stats?.pendingEarnings || "0" }));
    } catch {
    ...
    return (
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 md:mb-8">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-500/10 via-brand-500/5 to-transparent dark:from-brand-500/20 dark:via-brand-500/10 dark:to-transparent border border-brand-200/50 dark:border-brand-500/20 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-brand-500/10 hover:border-brand-300 dark:hover:border-brand-500/40">
              ...
              <div className="relative flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">{t("promo.commissionRate")}</p>
                  <p className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{t("promo.upTo15")}</p>
                  <p className="text-xs text-brand-500 font-medium mt-1">{t("promo.perSale")}</p>
                </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/10 via-purple-500/5 to-transparent dark:from-purple-500/20 dark:via-purple-500/10 dark:to-transparent border border-purple-200/50 dark:border-purple-500/20 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10 hover:border-purple-300 dark:hover:border-purple-500/40">
              ...
              <div className="relative flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">{t("promo.tierLevels")}</p>
                  <p className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{t("promo.fourTiers")}</p>
                  <p className="text-xs text-purple-500 font-medium mt-1">{t("promo.starterToPlatinum")}</p>
                </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent dark:from-emerald-500/20 dark:via-emerald-500/10 dark:to-transparent border border-emerald-200/50 dark:border-emerald-500/20 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10 hover:border-emerald-300 dark:hover:border-emerald-500/40">
              ...
              <div className="relative flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">{t("promo.payouts")}</p>
                  <p className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{t("promo.weekly")}</p>
                  <p className="text-xs text-emerald-500 font-medium mt-1">{t("promo.noMinimum")}</p>
                </div>
          ...
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t("tierPreview.title")}</h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={cn(
                      ...
                      {tier.minReferrals === 0 ? t("promo.noMinReferrals") : t("promo.minReferrals", { count: tier.minReferrals })}
                    </div>
                  </div>
                );
              })}
              ...
              <div className="max-w-2xl mx-auto text-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
                  <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                    ...
                    <span className="text-gray-300">{t("cta.freeToJoin")}</span>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                    <div className="w-5 h-5 rounded-full bg-emerald-500/20 flex items-center justify-center">
                      <CheckCircle className="h-3.5 w-3.5 text-emerald-400" />
                    </div>
                    <span className="text-gray-300">{t("cta.noMinPayout")}</span>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                    <div className="w-5 h-5 rounded-full bg-emerald-500/20 flex items-center justify-center">
                      <CheckCircle className="h-3.5 w-3.5 text-emerald-400" />
                    </div>
                    <span className="text-gray-300">{t("cta.weeklyPayouts")}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
                ...
                <div className="flex-1">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                    <li className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                      ...
                      {t("suspended.codeInactive")}
                    </li>
                    <li className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                      <span className="w-1.5 h-1.5 rounded-full bg-red-500"></span>
                      {t("suspended.noNewCommissions")}
                    </li>
                    <li className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                      <span className="w-1.5 h-1.5 rounded-full bg-red-500"></span>
                      {t("suspended.hiddenFromLeaderboard")}
                    </li>
                  </ul>
                </div>
          ...
          <div className="relative p-6 md:p-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-5">
                ...
                {/* Tier Details */}
                <div>
                  <p className="text-sm text-white/70 mb-1">{t("dashboard.yourCurrentTier")}</p>
                  <h2 className="text-2xl md:text-3xl font-bold mb-1 text-white">
                    {displayAffiliate.tier?.name || "Starter"}
                  </h2>
                  <div className="flex items-center gap-3">
                    <span className="font-semibold text-lg text-white">
                      {displayAffiliate.tier?.commissionRate || "3"}% {t("dashboard.commission")}
                    </span>
                    <span className="text-white/50">•</span>
                    <span className="text-white/80 text-sm">
                      {displayStats?.totalReferrals || 0} {t("dashboard.referrals")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              {displayAffiliate.nextTier ? (
                <div className="flex-1 max-w-md">
                  <div className="flex items-center justify-between text-sm mb-2">
                    <span className="text-white/70">{t("dashboard.progressTo", { tier: displayAffiliate.nextTier.name })}</span>
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-white/60">
                      {displayStats?.totalReferrals || 0} / {displayAffiliate.nextTier.minReferrals} {t("dashboard.referrals")}
                    </span>
                    <span className="text-white/70">
                      {t("dashboard.next")} <span className="font-medium text-white">{displayAffiliate.nextTier.commissionRate}%</span>
                    </span>
                  </div>
                </div>
              ) : (
                <div className="flex items-center gap-3 px-5 py-3 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
                  ...
                  <div>
                    <p className="font-semibold text-white">{t("dashboard.maxTierAchieved")}</p>
                    <p className="text-sm text-white/70">{t("dashboard.reachedHighest")}</p>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 md:mb-8">
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500/10 via-blue-500/5 to-transparent dark:from-blue-500/20 dark:via-blue-500/10 dark:to-transparent border border-blue-200/50 dark:border-blue-500/20 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 hover:border-blue-300 dark:hover:border-blue-500/40">
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">{t("dashboard.totalReferrals")}</p>
                <p className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{displayStats?.totalReferrals || 0}</p>
                <p className="text-xs text-blue-500 font-medium mt-1">{t("dashboard.users")}</p>
              </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-500/10 via-brand-500/5 to-transparent dark:from-brand-500/20 dark:via-brand-500/10 dark:to-transparent border border-brand-200/50 dark:border-brand-500/20 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-brand-500/10 hover:border-brand-300 dark:hover:border-brand-500/40">
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">{t("dashboard.totalEarnings")}</p>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent dark:from-emerald-500/20 dark:via-emerald-500/10 dark:to-transparent border border-emerald-200/50 dark:border-emerald-500/20 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10 hover:border-emerald-300 dark:hover:border-emerald-500/40">
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">{t("dashboard.thisMonth")}</p>
              ...
              <div className="relative p-6">
                <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-gray-900 dark:text-white">{t("dashboard.yourReferralLink")}</h2>
                      <p className="text-gray-500 dark:text-gray-400 text-sm">{t("dashboard.shareAndEarn", { rate: displayAffiliate.tier?.commissionRate || "3" })}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="flex items-center gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                      ...
                      >
                        {copied ? (
                          <><Check className="h-4 w-4" /> {t("dashboard.copied")}</>
                        ) : (
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                        <span className="text-xs text-gray-500 dark:text-gray-400">{t("dashboard.code")}</span>
                ...
                <div className="relative border border-gray-200/50 dark:border-gray-700/50 rounded-2xl overflow-hidden">
                  ...
                  <div className="flex items-center justify-between p-5 border-b border-gray-200/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h2 className="font-bold text-gray-900 dark:text-white">{t("recentCommissions.title")}</h2>
                        <p className="text-xs text-gray-500">
                          {commissionsData?.summary?.totalEarned
                            ? t("recentCommissions.totalEarned", { amount: parseFloat(commissionsData.summary.totalEarned).toLocaleString() })
                            : t("recentCommissions.history")}
                        </p>
                      </div>
                    </div>
                    {recentCommissions.length > 0 && (
                      <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-100 dark:bg-emerald-900/30">
                        ...
                        <span className="text-sm font-medium text-emerald-700 dark:text-emerald-400">
                          {t("recentCommissions.transactions", { count: recentCommissions.length })}
                        </span>
                      </div>
                    )}
                  </div>
                    ...
                    >
                      {commissionsLoading ? (
                        <div className="flex flex-col items-center justify-center py-12 px-4">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 font-medium">{t("recentCommissions.loading")}</p>
                        </div>
                      ) : recentCommissions.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-12 px-4">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 font-medium">{t("recentCommissions.noCommissions")}</p>
                          <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">{t("recentCommissions.shareToStart")}</p>
                        </div>
                      ) : (
                        recentCommissions.map((commission) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="font-medium text-gray-900 dark:text-white">{t("recentCommissions.referralCommission")}</p>
                    ...
                    {recentCommissions.length > 6 && showScrollIndicator && (
                      <div className="absolute bottom-0 left-0 right-0 pointer-events-none transition-opacity duration-300">
                        ...
                        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex flex-col items-center gap-0.5 animate-bounce">
                          <span className="text-[10px] font-medium text-gray-400 dark:text-gray-500">{t("recentCommissions.scrollForMore")}</span>
              ...
              <div className="relative overflow-hidden rounded-2xl">
                ...
                <div className="relative border border-amber-200/50 dark:border-amber-500/20 rounded-2xl overflow-hidden">
                  ...
                  <div className="relative p-5 text-center border-b border-amber-200/50 dark:border-amber-500/20 bg-gradient-to-b from-amber-100/50 to-transparent dark:from-amber-500/10">
                    ...
                    <h2 className="font-bold text-gray-900 dark:text-white">{t("leaderboardCard.title")}</h2>
                    <p className="text-xs text-gray-500">{t("leaderboardCard.subtitle")}</p>
                  </div>
                  ...
                  {leaderboard.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-8 px-4">
                      ...
                      <p className="text-sm font-medium text-gray-600 dark:text-gray-400">{t("leaderboardCard.noLeaders")}</p>
                      <p className="text-xs text-gray-500 mt-1">{t("leaderboardCard.beFirst")}</p>
                    </div>
                  ) : (
                      ...
                      {leaderboard[1] && (
                        <div className="flex flex-col items-center">
                          ...
                          <div className="w-16 h-16 bg-gradient-to-t from-gray-300 to-gray-400 dark:from-gray-600 dark:to-gray-500 rounded-t-lg flex flex-col items-center justify-center">
                            ...
                            <span className="text-xs font-bold text-gray-700 dark:text-gray-200">{t("leaderboardCard.second")}</span>
                          </div>
                      ...
                      {leaderboard[0] && (
                        <div className="flex flex-col items-center -mt-4">
                          ...
                          <div className="w-16 h-20 bg-gradient-to-t from-amber-400 to-amber-500 rounded-t-lg flex flex-col items-center justify-center shadow-lg">
                            ...
                            <span className="text-xs font-bold text-amber-900">{t("leaderboardCard.first")}</span>
                          </div>
                      ...
                      {leaderboard[2] && (
                        <div className="flex flex-col items-center">
                          ...
                          <div className="w-16 h-12 bg-gradient-to-t from-amber-600 to-amber-700 rounded-t-lg flex flex-col items-center justify-center">
                            ...
                            <span className="text-xs font-bold text-amber-100">{t("leaderboardCard.third")}</span>
                          </div>
                    ...
                    {leaderboard.slice(3, 5).map((entry) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-500">{entry.totalReferrals} {t("leaderboard.referrals")}</p>
                        </div>
                            ...
                            <div className="relative flex items-center gap-3 p-3 rounded-xl bg-amber-500/10 dark:bg-amber-500/20 border border-amber-500/30">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="font-semibold text-sm text-gray-900 dark:text-white flex items-center gap-1">
                                  {t("leaderboardCard.you")}
                                  <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-brand-500 text-white">{t("leaderboardCard.youBadge")}</span>
                                </p>
                                <p className="text-xs text-gray-500">
                                  {displayStats?.totalReferrals || 0} {t("leaderboard.referrals")}
                                  {!userRank && leaderboard.length > 0 && ` · ${t("leaderboardCard.notInTop", { count: leaderboard.length })}`}
                                </p>
                              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-5">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">{t("referralsTab.title")}</h2>
                    <div className="flex items-center gap-3 mt-1">
                      <span className="inline-flex items-center gap-1.5 text-sm text-gray-500">
                        <span className="w-2 h-2 rounded-full bg-gray-400"></span>
                        {referralsSummary.total} {t("referralsTab.total")}
                      </span>
                      <span className="inline-flex items-center gap-1.5 text-sm text-emerald-600 dark:text-emerald-400">
                        <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                        {referralsSummary.converted} {t("referralsTab.converted")}
                      </span>
                      <span className="inline-flex items-center gap-1.5 text-sm text-blue-600 dark:text-blue-400">
                        <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                        {referralsSummary.active} {t("referralsTab.active")}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative w-full lg:w-72">
                  ...
                  <Input
                    placeholder={t("referralsTab.searchPlaceholder")}
                    value={searchQuery}
            ...
            <div className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 overflow-hidden">
              ...
              <div className="hidden md:grid md:grid-cols-12 gap-4 px-6 py-3 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-800 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                <div className="col-span-4">{t("referralsTab.tableHeaders.user")}</div>
                <div className="col-span-2">{t("referralsTab.tableHeaders.status")}</div>
                <div className="col-span-2 text-right">{t("referralsTab.tableHeaders.joined")}</div>
                <div className="col-span-2 text-right">{t("referralsTab.tableHeaders.purchases")}</div>
                <div className="col-span-2 text-right">{t("referralsTab.tableHeaders.commission")}</div>
              </div>
              ...
              <div className="divide-y divide-gray-100 dark:divide-gray-800">
                {referralsLoading ? (
                  <div className="p-16 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-medium">{t("referralsTab.loading")}</p>
                  </div>
                  ...
                  <div className="p-16 text-center">
                    ...
                    <p className="text-gray-900 dark:text-white font-medium">{t("referralsTab.noReferrals")}</p>
                    <p className="text-sm text-gray-500 mt-1">
                      {debouncedSearch || statusFilter !== 'all'
                        ? t("referralsTab.adjustFilters")
                        : t("referralsTab.shareToStart")}
                    </p>
                  </div>
                ) : (
              ...
              {referralsPagination.total > 0 && (
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-800">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <span>{t("referralsTab.ofEntries", { total: referralsPagination.total })}</span>
                  </div>
